...
public class SendNoUpdate extends AsyncTask<Void, Integer, Object> {
    ...
    public SendNoUpdate(MainActivity mainActivity, HashMap<String, Object> product) {
    ...
    protected void onPostExecute(Object o) {
        ...
        this.mainActivity.onQuantityValidated(results);
    }
}
